  ...
  return (
    <div className="flex justify-center bg-red-700 h-screen">
      <div className="w-11/12 rounded-lg border bg-gray-700">
        ...
        <div id="desc" className="text-xl py-2 px-4 leading-relaxed text-white">このゲームはプログラミングでたたかうシューティングゲームです。<br/>キャラクターのうごきをプログラミングして、あいてをたおしましょう。<br/>水色のアクションブロックをタッチするとプログラムをつくれます。<ul className="m-2"><li><span className="bg-blue-400 rounded-lg font-bold p-1 my-2">こうげき</span>：あいてをこうげき</li><li><span className="bg-blue-400 rounded-lg font-bold p-1 my-2">ためる</span>: こうげき力をあげる</li><li><span className="bg-blue-400 rounded-lg font-bold p-1 my-2">うえ/したにうごく</span>：うえやしたにうごく</li></ul></div>
